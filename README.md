...
- [TestRaptor](https://testraptor.com) - TLS certificate checks, uptime monitoring, and page screenshots for AI agents, sold pay-per-call over x402 (USDC on Solana, gas sponsored). [MCP server](https://www.npmjs.com/package/testraptor-x402-mcp) · [Discovery](https://testraptor.com/.well-known/x402).
