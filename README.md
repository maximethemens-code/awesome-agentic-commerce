...
- [Lingua Detective](https://linguadetective.com) - Language detection and verification, sold pay-per-call over x402 (USDC on Solana, gas sponsored). [MCP server](https://www.npmjs.com/package/lingua-x402-mcp) · [Discovery](https://linguadetective.com/.well-known/x402).
